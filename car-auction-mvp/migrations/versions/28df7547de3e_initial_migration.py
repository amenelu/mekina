...
def upgrade():
    ...
    sa.Column('is_bank_loan_available', sa.Boolean(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['accepted_bid_id'], ['dealer_bid.id'], name='fk_car_requests_accepted_bid_id', use_alter=True),
    ...
    sa.Column('price_with_loan', sa.Float(), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('status', sa.String(length=20), nullable=False),
    sa.Column('make', sa.String(length=64), nullable=False),
    sa.Column('model', sa.String(length=64), nullable=False),
    ...
    sa.Column('edit_point_deducted', sa.Boolean(), nullable=False),
    sa.Column('dealer_id', sa.Integer(), nullable=False),
